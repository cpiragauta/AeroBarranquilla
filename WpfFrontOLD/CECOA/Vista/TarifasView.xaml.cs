...
namespace WpfFront.Vista
{
    ...
    public partial class TarifasView : UserControlBase, ITarifasView
    {
        ...
        public event EventHandler<DataEventArgs<TarifaCecoa>> SeleccionarTarifas;
        ...
        {
            Tipo = AERODROMO;
            SeleccionarTarifas(sender, new DataEventArgs<TarifaCecoa>((TarifaCecoa)ListTarifas.SelectedItem));
        }
        ...
        {
            Tipo = AEROPORTUARIAS;
            SeleccionarTarifas(sender, new DataEventArgs<TarifaCecoa>((TarifaCecoa)ListTarifasArptrs.SelectedItem));
        }
        ...
        {
            Tipo = BOMBEROS;
            SeleccionarTarifas(sender, new DataEventArgs<TarifaCecoa>((TarifaCecoa)ListTarifasBomber.SelectedItem));
        }
        ...
        {
            Tipo = PUENTES;
            SeleccionarTarifas(sender, new DataEventArgs<TarifaCecoa>((TarifaCecoa)ListTarifasPuents.SelectedItem));
        }
        ...
        {
            Tipo = PARQUEO;
            SeleccionarTarifas(sender, new DataEventArgs<TarifaCecoa>((TarifaCecoa)ListTarifasParqos.SelectedItem));
        }
    ...
    public interface ITarifasView
    {
        ...
        event EventHandler<DataEventArgs<TarifaCecoa>> SeleccionarTarifas;
